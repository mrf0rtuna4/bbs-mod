...
public enum Interpolation implements IInterpolation
{
    LINEAR("linear", GLFW.GLFW_KEY_L)
    {
        ...
        {
            return Interpolations.lerp(context.a, context.b, context.x);
        }
    },
    ...
    BACK_IN("back_in", GLFW.GLFW_KEY_B)
    {
        ...
        public double interpolate(InterpolationContext context)
        {
            ...
            return Interpolations.lerp(context.a, context.b, c3 * x * x * x - c1 * x * x);
        }
    },
    BACK_OUT("back_out", GLFW.GLFW_KEY_B)
    {
        ...
        public double interpolate(InterpolationContext context)
        {
            ...
            return Interpolations.lerp(context.a, context.b, 1 + c3 * Math.pow(x - 1, 3) + c1 * Math.pow(x - 1, 2));
        }
    },
    BACK_INOUT("back_inout", GLFW.GLFW_KEY_B)
    {
        ...
        public double interpolate(InterpolationContext context)
        {
            ...
            return Interpolations.lerp(context.a, context.b, factor);
        }
    },
    ...
    BOUNCE_IN("bounce_in", GLFW.GLFW_KEY_O)
    {
        ...
        public double interpolate(InterpolationContext context)
        {
            ...
            return Interpolations.lerp(context.a, context.b, 1 - BOUNCE_OUT.interpolate(0, 1, 1 - x));
        }
    },
    ...
    CIRCULAR("circle", GLFW.GLFW_KEY_P)
    {
        ...
        public double interpolate(InterpolationContext context)
        {
            return Interpolations.cubicHermite(context.a, context.a, context.b, context.b, context.x);
        }
    },
    CUBIC("cubic", GLFW.GLFW_KEY_K)
    {
        ...
        public double interpolate(InterpolationContext context)
        {
            return Interpolations.cubic(context.v1, context.a, context.b, context.v2, context.x);
        }
    },
    HERMITE("hermite", GLFW.GLFW_KEY_H)
    {
        ...
        public double interpolate(InterpolationContext context)
        {
            return Interpolations.cubicHermite(context.v1, context.a, context.b, context.v2, context.x);
        }
    },
