package mchorse.bbs_mod.graphics.vao;
...
public class VAOBuilder
{
    ...
    /* TODO: public VAOBuilder shader(Shader shader)
    {
        this.shader = shader;
