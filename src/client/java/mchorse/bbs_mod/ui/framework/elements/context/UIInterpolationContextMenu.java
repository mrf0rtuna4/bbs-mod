...
public class UIInterpolationContextMenu extends UIContextMenu
{
    ...
    static
    {
        ...
        INTERP_ICON_MAP.put(Interpolations.QUAD_IN, Icons.INTERP_QUAD);
        INTERP_ICON_MAP.put(Interpolations.QUAD_OUT, Icons.INTERP_QUAD);
        INTERP_ICON_MAP.put(Interpolations.QUAD_INOUT, Icons.INTERP_QUAD);
        INTERP_ICON_MAP.put(Interpolations.CUBIC_IN, Icons.INTERP_CUBIC);
        INTERP_ICON_MAP.put(Interpolations.CUBIC_OUT, Icons.INTERP_CUBIC);
        INTERP_ICON_MAP.put(Interpolations.CUBIC_INOUT, Icons.INTERP_CUBIC);
        INTERP_ICON_MAP.put(Interpolations.EXP_IN, Icons.INTERP_EXP);
        INTERP_ICON_MAP.put(Interpolations.EXP_OUT, Icons.INTERP_EXP);
        INTERP_ICON_MAP.put(Interpolations.EXP_INOUT, Icons.INTERP_EXP);
        INTERP_ICON_MAP.put(Interpolations.BACK_IN, Icons.INTERP_BACK);
        INTERP_ICON_MAP.put(Interpolations.BACK_OUT, Icons.INTERP_BACK);
        INTERP_ICON_MAP.put(Interpolations.BACK_INOUT, Icons.INTERP_BACK);
        INTERP_ICON_MAP.put(Interpolations.ELASTIC_IN, Icons.INTERP_ELASTIC);
        INTERP_ICON_MAP.put(Interpolations.ELASTIC_OUT, Icons.INTERP_ELASTIC);
        INTERP_ICON_MAP.put(Interpolations.ELASTIC_INOUT, Icons.INTERP_ELASTIC);
        INTERP_ICON_MAP.put(Interpolations.BOUNCE_IN, Icons.INTERP_BOUNCE);
        INTERP_ICON_MAP.put(Interpolations.BOUNCE_OUT, Icons.INTERP_BOUNCE);
        INTERP_ICON_MAP.put(Interpolations.BOUNCE_INOUT, Icons.INTERP_BOUNCE);
        INTERP_ICON_MAP.put(Interpolations.SINE_IN, Icons.INTERP_SINE);
        INTERP_ICON_MAP.put(Interpolations.SINE_OUT, Icons.INTERP_SINE);
        INTERP_ICON_MAP.put(Interpolations.SINE_INOUT, Icons.INTERP_SINE);
        INTERP_ICON_MAP.put(Interpolations.QUART_IN, Icons.INTERP_QUART);
        INTERP_ICON_MAP.put(Interpolations.QUART_OUT, Icons.INTERP_QUART);
        INTERP_ICON_MAP.put(Interpolations.QUART_INOUT, Icons.INTERP_QUART);
        INTERP_ICON_MAP.put(Interpolations.QUINT_IN, Icons.INTERP_QUINT);
        INTERP_ICON_MAP.put(Interpolations.QUINT_OUT, Icons.INTERP_QUINT);
        INTERP_ICON_MAP.put(Interpolations.QUINT_INOUT, Icons.INTERP_QUINT);
        INTERP_ICON_MAP.put(Interpolations.CIRCLE_IN, Icons.INTERP_CIRCLE);
        INTERP_ICON_MAP.put(Interpolations.CIRCLE_OUT, Icons.INTERP_CIRCLE);
        INTERP_ICON_MAP.put(Interpolations.CIRCLE_INOUT, Icons.INTERP_CIRCLE);
        INTERP_ICON_MAP.put(Interpolations.CIRCULAR, Icons.INTERP_CIRCLE);
        INTERP_ICON_MAP.put(Interpolations.CUBIC, Icons.INTERP_CUBIC);
        INTERP_ICON_MAP.put(Interpolations.HERMITE, Icons.INTERP_CUBIC);
